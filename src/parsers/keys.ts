...
export class Parser<T> {
  ...
  constructor(keyConditions: KeyConditions<T>) {
    this.keyExpressionInfo = mapKeyCondition(
      keyConditions,
      this.keyConditionExpressionInfo,
    );
  }
  ...
  keyConditionExpressionInfo<T, U extends keyof T>(
    compareExpression: KeyExpression<T, U>,
