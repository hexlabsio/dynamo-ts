...
export default class IndexClient<T extends DynamoInfo, Parent extends DynamoInfo> {

  constructor(public readonly parent: Parent, public readonly info: T, private readonly config: DynamoConfig) {}
